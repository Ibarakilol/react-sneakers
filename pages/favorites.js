    ...
    return (
      <Layout>
        <section className="empty">
          <img className="empty__emoji" src="/assets/images/pleading-emoji.svg" alt="Закладок нет :(" />
          <h1 className="empty__title">Закладок нет :(</h1>
          <p className="empty__text">Вы ничего не добавляли в закладки</p>
          <Link href="/">
      ...
      <section className="main__inner">
        <div className="wrapper">
          <div className="main__heading">
            ...
            <h1 className="main__title title">Мои закладки</h1>
          </div>
