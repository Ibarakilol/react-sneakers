          ...
          <div className="header__logo">
            <Link href="/">
              <a className="header__logo-link">
                <img className="header__logo-img" src="/assets/images/logo.svg" alt="React Sneakers" />
              </a>
            </Link>
            <div className="header__logo-content">
              <span className="header__logo-text">REACT SNEAKERS</span>
              <span className="header__logo-tagline">Магазин лучших кроссовок</span>
            </div>
          </div>
          <ul className="header__menu">
            <li className="header__menu-item">
              <button className="header__menu-cart" onClick={handleCart}>
                ...
                {total !== 0 && <span className="header__menu-cart__price">{convertPrice(total)} руб.</span>}
              </button>
            </li>
            <li className="header__menu-item">
              <Link href="/favorites">
